...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("CAB");
    case mBTC: return QString("mCAB");
    case uBTC: return QString::fromUtf8("μCAB");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("Cabbages"));
    case mBTC: return QString(QObject::tr("Milli-Cabbages (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-Cabbages (1 / 1,000,000)"));
    default: return QString("???");
    }
}
